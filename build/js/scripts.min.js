...
function Popup(n){}
!function(e,t){"use strict";var n=e.navigator.userAgent.toLowerCase();if(/trident/gi.test(n)||/msie/gi.test(n)){for(var r,a=t.querySelectorAll("use"),i=0;i<a.length;i++)r="#"+(r=a[i].getAttribute("xlink:href")).split("#")[1],a[i].setAttribute("xlink:href",r);if(!t.createElementNS||!t.createElementNS("http://www.w3.org/2000/svg","svg").createSVGRect)return;var o,l,s="localStorage"in e&&null!==e.localStorage,g=function(){t.body.insertAdjacentHTML("afterbegin",l)},c=function(){t.body?g():t.addEventListener("DOMContentLoaded",g)};if(s&&7==localStorage.getItem("inlineSVGrev")&&(l=localStorage.getItem("inlineSVGdata")))return c();try{(o=new XMLHttpRequest).open("GET","img/svg/symbol/sprite.svg",!0),o.onload=function(){200<=o.status&&o.status<400&&(l=o.responseText,c(),s&&(localStorage.setItem("inlineSVGdata",l),localStorage.setItem("inlineSVGrev",7)))},o.send()}catch(e){}}}(window,document);
$(document).ready(function(){var o=window.navigator.userAgent.toLowerCase();if(/trident/gi.test(o)||/msie/gi.test(o)){document.createElement("picture");var n=$(".social__icon"),i=$(".social__link"),t=!1;n.on("mousedown",function(){$(this).css({opacity:.3}),t=!0}),$("html").on("mousemove",function(){t=!1}),i.on("mouseout",function(){$(this).children().css("opacity",1),t=!1}),n.on("mousemove",function(){t||$(this).css("opacity",1)});var e=$(".main-footer__author-link"),s=($(".main-footer__author-icon"),!1);e.on("mousedown",function(){$(this).children().css({fill:"#a9a9a9"}),s=!0}),$("html").on("mousemove",function(){s=!1}),e.on("mouseout",function(){$(this).children().css({fill:"#000000"}),s=!1}),e.on("mousemove",function(){s||$(this).children().css({fill:"#81b3d2"})}),$(".range__field").css("padding","2px 5px 9px")}});
$(document).ready(function(){$(".feedback__button").on("click",function(){$(".feedback__form").toggleClass("feedback__form--visually")}),$('[data-toggle="datepicker-start"]').datepicker({format:"dd mm yyyy",language:"ru-RU",trigger:'.feedback__date-button[name="dayStart"]'}),$('[data-toggle="datepicker-end"]').datepicker({format:"dd mm yyyy",language:"ru-RU",trigger:'.feedback__date-button[name="dayFinish"]'})});